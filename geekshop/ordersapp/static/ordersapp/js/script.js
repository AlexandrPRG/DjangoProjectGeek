window.onload = function () {
    ...
    for (var i=0; i<total_forms; i++) {
        ...
        function orderSummaryUpdate(orderitem_price, delta_quantity) {
            ...
            order_total_price = Number((order_total_price + delta_cost).toFixed(fractionDigits: 2))
        ...
        $('.order_total_quantity').html(order_total_quantity.toString());
        $('.order_total_cost').html(order_total_price.toFixed(fractionDigits: 2).toString());
    }
                    ...
                    success: function (data) {
                        ...
                        price_arr[orderitem_num] = parseFloat(data.price);
                            ...
                            let price_html = '<span>' +
                                    ...
                                    '</span> руб.';
                            let current_tr = $('.order_form table').find(
                                    selector: 'tr:eq(' +
                                            (orderitem_num + 1) +
                                            ')'
                                    );
